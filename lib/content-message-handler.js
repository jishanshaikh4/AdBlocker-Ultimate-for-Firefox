    ...
    function handleMessage(message, sender, callback) {
        switch (message.type) {
            case 'updateUserRated':
                adguard.pageStats.updateUserRated(message.val);
                break;
            case 'showBadgeAgain':
                adguard.pageStats.setShowBadgeAgain(message.val);
                break;
            case 'getShieldLocalization':
                ...
                callback({'message': adguard.i18n.getMessage(message.key, message.value), 'key': message.key});
                break;
            case 'getUserRank':
                callback(adguard.pageStats.getUserRank());
                break;
            case 'showPageStatistic':
                callback(adguard.settings.showPageStatistic());
                break;
            case 'changeShowPageStatistic':
                adguard.settings.changeShowPageStatistic(message.show);
                break;
