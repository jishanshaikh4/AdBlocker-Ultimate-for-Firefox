...
adguard.ui = (function (adguard) { // jshint ignore:line
    ...
    function getAssistantOptions() {
        ...
        assistantOptions = {
            cssLink: [adguard.getURL('lib/content-script/assistant/css/select.css'),
                        adguard.getURL('lib/content-script/assistant/css/font-awesome.css'),
                        adguard.getURL('lib/content-script/assistant/css/font-awesome.min.css')
            ],
    ...
    var openSiteReportTab = function (url) {
        console.log('openSiteReportTab1');
        var domain = adguard.utils.url.toPunyCode(url);
        if (domain) {
            console.log('openSiteReportTab2');
            openTab("https://adblockultimate.net/report.html?url=" + encodeURIComponent(domain));
        }
    };
    ...
    var openThankYouPage = function () {
        ...
        var thankyouUrl = 'https://adblockultimate.net/contribute.html';
    ...
    var openUserPromotedPanel = function(rank){
        rank['baseUrl'] = adguard.getURL('/pages/shield/');
        rank['template'] = null;
        ...
        adguard.tabs.getActive(function(tab){
            browser.tabs.sendMessage(tab.tabId,{type: 'initShield', rank: rank});
        });
...
*/
    ...
    return {
        openUserPromotedPanel: openUserPromotedPanel,
